...
# 1. install timd for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for timd
# 5. create timd, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable tim_SOCKET
...
!define GROUPNAME "tim"
!define APPNAME "timd"
!define DESCRIPTION "Official Go implementation of the tim protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since timd is installed global
