...
import (
	...
	"github.com/tim-coin/tim/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the tim contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the tim contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the tim contract Solidity source to build and bind")
