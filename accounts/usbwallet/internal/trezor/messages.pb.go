...
const (
	...
	MessageType_MessageType_timSignMessage      MessageType = 64
	MessageType_MessageType_timVerifyMessage    MessageType = 65
	MessageType_MessageType_timMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	64:  "MessageType_timSignMessage",
	65:  "MessageType_timVerifyMessage",
	66:  "MessageType_timMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_timSignMessage":      64,
	"MessageType_timVerifyMessage":    65,
	"MessageType_timMessageSignature": 66,
...
func (m *ApplySettings) timdomescreen() []byte {
	if m != nil {
		return m.Homescreen
	}
	return nil
...
func (m *EncryptedMessage) timdmac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
func (m *DecryptMessage) timdmac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next timMessageSignature
// @next Failure
type timSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *timSignMessage) Reset()                    { *m = timSignMessage{} }
func (m *timSignMessage) String() string            { return proto.CompactTextString(m) }
func (*timSignMessage) ProtoMessage()               {}
func (*timSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *timSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *timSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *timVerifyMessage) Reset()                    { *m = timVerifyMessage{} }
func (m *timVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*timVerifyMessage) ProtoMessage()               {}
func (*timVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *timVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *timVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *timVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// Response: Signed message
// @prev timSignMessage
type timMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *timMessageSignature) Reset()                    { *m = timMessageSignature{} }
func (m *timMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*timMessageSignature) ProtoMessage()               {}
func (*timMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *timMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *timMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
