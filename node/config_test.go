...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "timd.ipc", false, filepath.Join(os.TempDir(), "timd.ipc")},
		{"data", "timd.ipc", false, "data/timd.ipc"},
		{"data", "./timd.ipc", false, "./timd.ipc"},
		{"data", "/timd.ipc", false, "/timd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "timd.ipc", true, `\\.\pipe\timd.ipc`},
		{"data", "timd.ipc", true, `\\.\pipe\timd.ipc`},
		{"data", `\\.\pipe\timd.ipc`, true, `\\.\pipe\timd.ipc`},
	}
