...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllthashProtocolChanges, new: AllthashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllthashProtocolChanges, new: AllthashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllthashProtocolChanges,
