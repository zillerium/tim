...
import (
	...
	"github.com/tim-coin/tim/logger"
	"github.com/tim-coin/tim/p2p"
	"github.com/tim-coin/tim/p2p/nat"
	"github.com/tim-coin/tim/whisper"
)
...
func main() {
	...
	// Create an tim peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting tim peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start tim peer: %v.\n", err)
		os.Exit(1)
	}
