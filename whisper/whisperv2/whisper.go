...
import (
	...
	"github.com/tim-coin/tim/crypto/ecies"
	"github.com/tim-coin/tim/event/filter"
...
// Whisper represents a dark communication interface through the tim
...
// New creates a Whisper client ready to communicate through the tim P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
