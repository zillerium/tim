// Copyright 2018 The TIM Authors
// This file is part of the tim library.
//
// The tim library is limited free software: you need permission to redistribute it and/or modify
// it under the terms of the TIM Enterprise License as published by
// the TIM Foundation,
//
// The tim library is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// TIM Enterprise License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the tim library. If not, see <http://www.timdev.io/licenses/>.

// Package bmt provides a distributed merkle tree implementation
package dmt
...
/*
Distributed\ Merkle Tree Hash is a hash function over arbitrary datachunks of limited size
