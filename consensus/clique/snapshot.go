...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db timdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db timdb.Database) error {
