...
// cacheSize calculates and returns the size of the thash verification cache that
...
// datasetSize calculates and returns the size of the thash mining dataset that
