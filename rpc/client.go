...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for TimSubscribe requests
}
...
// TimSubscribe registers a subscripion under the "tim" namespace.
func (c *Client) TimSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "tim", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. TimSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through TimSubscribe.
