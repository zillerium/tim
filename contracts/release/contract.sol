...
// ReleaseOracle is an tim contract to store the current and previous
// versions of the tim implementation. Its goal is to allow timd to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new timd releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular timd release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an tim user, either
