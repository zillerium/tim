...
// Package chequebook package wraps the 'chequebook' tim smart contract.
//
...
import (
	...
	"github.com/tim-coin/tim/contracts/chequebook/contract"
	"github.com/tim-coin/tim/core/types"
	"github.com/tim-coin/tim/crypto"
	"github.com/tim-coin/tim/log"
	"github.com/tim-coin/tim/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an tim transaction.
