...
type downloadTester struct {
	...
	stateDb timdb.Database // Database used by the tester for syncing from peers
	peerDb  timdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = timdb.NewMemDatabase()
