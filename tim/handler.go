...
import (
	...
	"github.com/tim-coin/tim/tim/fetcher"
...
// TimNodeInfo represents a short summary of the tim sub-protocol metadata known
// about the host peer.
type TimNodeInfo struct {
...
func (self *ProtocolManager) NodeInfo() *TimNodeInfo {
