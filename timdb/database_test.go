...
func newTestLDB() (*timdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "timdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := timdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db timdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db timdb.Database, t *testing.T) {
	const n = 8
