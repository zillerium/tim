...
// Package types contains data types related to tim consensus.
package types
...
// a block's data contents (transactions and uncles) totimder.
type Body struct {
...
// EncodeRLP serializes b into the tim RLP block format.
