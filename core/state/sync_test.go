...
func makeTestState() (Database, *timdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := timdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db timdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db timdb.Database, root common.Hash) error {
...
func checkStateConsistency(db timdb.Database, root common.Hash) error {
