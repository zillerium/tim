...
// Package state provides a caching layer atop the tim state trie.
package state
...
// StateDBs within the tim protocol are used to store anything
...
//
// Carrying over the balance ensures that Tim doesn't disappear.
