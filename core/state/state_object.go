...
// stateObject represents an tim account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of tim address of the account
	data     Account
	db       *StateDB
...
// Account is the tim consensus representation of accounts.
